...
const Sidebar = () => {
  ...
  return (
    <div className="bg-pink-500 border-t border-solid border-t-pink-600 max-w-[250px] flex-[0.3] text-white overflow-auto">
      <div className="flex p-3 border-b border-solid border-b-pink-600 pb-2.5">
        <div className="flex-[1]">
          ...
          <h3 className="flex items-center font-normal text-sm">
            <MdFiberManualRecord className="text-sm mt-1 mr-1 text-green-800" />
            {`${userData?.firstName} ${userData?.lastName}`}
          </h3>
        </div>
        <MdCreate className="p-2 text-pink-500 text-3xl bg-pink-600 rounded-full" />
      </div>
      <SidebarOptions />
